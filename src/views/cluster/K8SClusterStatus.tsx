      ...
      nodes = definition.result.nodeList.nodes.map((node) => {
        ...
        return <div className="ms-Grid-row" style={{padding: 0}} key={node.objectMeta.name}>
          <div className="ms-Grid-col ms-u-sm12 ms-u-md12 ms-u-lg12">
            <div className="ms-fontSize-xxl">Kubernetes Node: {node.objectMeta.name}</div>
          </div>
          <div className="ms-Grid-col ms-u-sm12 ms-u-md12 ms-u-lg12">
        ...
        <div className="ms-Grid" style={{padding: 0}}>
          <div className="ms-Grid-row" style={{padding: 0}}>
            <div className="ms-Grid-col ms-u-sm12 ms-u-md12 ms-u-lg12">
              ...
              <div className="ms-fontSize-l">The Kubernetes Nodes host the Kubernetes Master and Workers.</div>
            </div>
          </div> 
          <K8SClusterHealth/>
          <hr/>
